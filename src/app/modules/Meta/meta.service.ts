...
// SUPER_ADMIN, ADMIN, DOCTOR, PATIENT these type of user can see their profile's information data.
// such as count, total, no of review, bar chart etc. these kind of data is meta data
